...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_newsletter_subscribers_locale" AS ENUM('es', 'en');
  CREATE TYPE "public"."enum_newsletter_subscribers_status" AS ENUM('pending', 'confirmed', 'unsubscribed');
  CREATE TYPE "public"."enum_contacts_locale" AS ENUM('es', 'en');
  CREATE TYPE "public"."enum_contacts_status" AS ENUM('new', 'in_review', 'answered', 'spam', 'archived');
  ...
  CREATE TABLE "newsletter_subscribers" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"email" varchar NOT NULL,
  	"locale" "enum_newsletter_subscribers_locale" DEFAULT 'es' NOT NULL,
  ...
  CREATE TABLE "contacts" (
  	...
  	"locale" "enum_contacts_locale" DEFAULT 'es' NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_contacts_locale";
